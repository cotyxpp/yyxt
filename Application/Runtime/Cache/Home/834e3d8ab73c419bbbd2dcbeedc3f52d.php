...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/yyxt/Public/css/jquery-ui.css">
        ...
        <div class="col-xs-12">
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div id="tabs">
                        <ul>
                            <?php if(is_array(C("CONFIG_GROUP_LIST"))): $i = 0; $__LIST__ = C("CONFIG_GROUP_LIST");if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$g): $mod = ($i % 2 );++$i;?><li>
                                    <a href="#tabs-<?php echo ($key); ?>"><?php echo ($g); ?>配置</a>
                                </li><?php endforeach; endif; else: echo "" ;endif; ?>
                        </ul>
                        <div class="clearfix"></div>
                        <?php if(is_array(C("CONFIG_GROUP_LIST"))): $group = 0; $__LIST__ = C("CONFIG_GROUP_LIST");if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$g): $mod = ($group % 2 );++$group;?><div id="tabs-<?php echo ($group); ?>">
                                <form class="form-horizontal" role="form">
                                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if(($vo["group"]) == $group): ?><div class="form-group">
                                                <label class="col-sm-2 control-label" for="form-field-<?php echo ($vo["id"]); ?>" title="<?php echo ($vo["remark"]); ?>"><?php echo ($vo["title"]); ?>：</label>
                                                <div class="col-sm-6">
                                                    <?php switch($vo["type"]): case "0": ?><input type="text" id="form-field-<?php echo ($vo["id"]); ?>" class="col-xs-1 col-sm-1 input-sm" name="config[<?php echo ($vo["name"]); ?>]" value="<?php echo ($vo["value"]); ?>" /><?php break;?>
                                                        <?php case "1": ?><input type="text" id="form-field-<?php echo ($vo["id"]); ?>" class="col-xs-12 col-sm-12" name="config[<?php echo ($vo["name"]); ?>]" value="<?php echo ($vo["value"]); ?>" /><?php break;?>
                                                        <?php case "2": case "3": ?><textarea class="autosize-transition form-control" id="form-field-<?php echo ($vo["id"]); ?>" name="config[<?php echo ($vo["name"]); ?>]"><?php echo ($vo["value"]); ?></textarea><?php break;?>
                                                        <?php case "4": ?><select class="form-control" id="form-field-select-<?php echo ($vo["id"]); ?>" name="config[<?php echo ($vo["name"]); ?>]">
                                                                <?php $_result=parse_config_attr($vo['extra']);if(is_array($_result)): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($key); ?>" <?php if(($vo["value"]) == $key): ?>selected<?php endif; ?> ><?php echo ($vo); ?>
                                        </option><?php endforeach; endif; else: echo "" ;endif; ?>
                                        </select><?php break; endswitch;?>
                                        <span class="help-inline col-xs-12 col-sm-7">
                                                    <span class="middle"><?php echo ((isset($vo["remark"]) && ($vo["remark"] !== ""))?($vo["remark"]):''); ?></span>
                                        </span>
                                        </div>
...
<a href="#" id="btn-scroll-up" class="btn-scroll-up btn btn-sm btn-inverse">
    ...
    <script src="/yyxt/Public/js/jquery-ui.js"></script>
    <script src="/yyxt/Public/js/jquery.ui.touch-punch.js"></script>
    <script src="/yyxt/Public/js/autosize.js"></script>
    <script type="text/javascript">

 ...
 <!-- /.ace-settings-container --> 
    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <div class="dd">
                <a href="<?php echo U('add');?>" class="btn btn-sm btn-warning">新 增</a>
                <a href="<?php echo U('delete');?>" class="btn btn-sm btn-danger">删 除</a>
            </div>
            <div class="hr"></div>
            <div>
                <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                    ...
                    <?php $color = array('success','warning','info','inverse'); ?>
                    <tbody>
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td class="center"><?php echo ($group[$vo['type']]); ?></td>
                                <td class="center">
                                    <span class="label label-sm label-<?php echo ($color[$vo['type']]); ?> arrowed-in"><?php echo ($type[$vo['type']]); ?></span>
                                </td>
                                <td class="center">
...
<a href="#" id="btn-scroll-up" class="btn-scroll-up btn btn-sm btn-inverse">
    ...
    <!-- page specific plugin scripts -->
    <script src="/yyxt/Public/js/dataTables/jquery.dataTables.js"></script>
    <script src="/yyxt/Public/js/dataTables/jquery.dataTables.bootstrap.js"></script>
    <script src="/yyxt/Public/js/dataTables/extensions/buttons/dataTables.buttons.js"></script>
    <script src="/yyxt/Public/js/dataTables/extensions/select/dataTables.select.js"></script>
    <script type="text/javascript">
    jQuery(function($) {
    ...
    //Highlight_Nav("<?php echo U('Config/index');?>");
    </script>
    ...
    <script src="/yyxt/Public/js/ace/ace.ajax-content.js"></script>
